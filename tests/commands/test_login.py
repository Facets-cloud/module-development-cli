...
def test_login_with_existing_profile_success(
    mock_fetch, mock_set_default, mock_credentials_file
):
    ...
    with patch("os.path.exists", return_value=True), patch(
        ...
        mock_fetch.assert_called_once_with(
            "https://test.example.com", "test_user", "test_token"
        )
...
@patch.object(sys.modules["ftf_cli.commands.login"], "set_default_profile")
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_with_existing_profile(
    mock_fetch, mock_set_default, runner, mock_credentials_file
):
...
def test_login_command_with_non_existing_profile_user_cancels(runner):
    ...
    with patch("os.path.exists", return_value=False):
        ...
        assert result.exit_code == 0
        assert (
            "Profile 'new_profile' doesn't exist. Do you want to create it?"
            in result.output
        )
...
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_with_non_existing_profile_user_creates(
    mock_fetch, mock_store, mock_set_default, runner
):
...
@patch.object(sys.modules["ftf_cli.commands.login"], "store_credentials")
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_with_all_credentials_provided(
    mock_fetch, mock_store, mock_set_default, runner
):
...
@patch.object(sys.modules["ftf_cli.commands.login"], "set_default_profile")
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_no_profile_with_existing_profiles(
    mock_fetch, mock_set_default, runner, mock_credentials_file
):
...
@patch.object(sys.modules["ftf_cli.commands.login"], "store_credentials")
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_no_profile_user_chooses_new_profile(
    mock_fetch, mock_store, mock_set_default, runner, mock_credentials_file
):
...
@patch.object(sys.modules["ftf_cli.commands.login"], "store_credentials")
@patch.object(sys.modules["ftf_cli.commands.login"], "fetch_user_details")
def test_login_command_no_profile_no_existing_profiles(
    mock_fetch, mock_store, mock_set_default, runner
):
